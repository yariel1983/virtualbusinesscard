                ...
                <form id="registerForm" name="registerForm" method="post"> 
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="inputEmail4" placeholder="Email:" required autocomplete="email">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Password</label>
                            <input type="password" class="form-control" id="inputPassword4" placeholder="Password:" required autocomplete="current-password">
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn input-block-level form-control btn-rounded z-depth-1a" id="register-btn">Register</button>
                </form>
